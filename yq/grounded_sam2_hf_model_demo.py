...
parser.add_argument("--text-prompt", default="ground.")
# parser.add_argument("--img-path", default="notebooks/images/truck.jpg")
parser.add_argument("--img-path", default="notebooks/sd-office-two/1729728887599034.jpg")
parser.add_argument("--sam2-checkpoint", default="./checkpoints/sam2.1_hiera_large.pt")
parser.add_argument("--sam2-model-config", default="configs/sam2.1/sam2.1_hiera_l.yaml")
# parser.add_argument("--output-dir", default="outputs/test_sam2.1")
parser.add_argument("--output-dir", default="notebooks/sd-office-two-result/1729728887599034")
